...
const references = [
  {
    ...
    Comment:
      "I am pleased to recommend Teila for a software development position. Teila is very organized, detailed orientated, and shows great leadership. For example, she has trained new employees on how to be a Legal Assistant, and how to be more effective at their jobs. She created a manual that her co-workers use as a reference to do the many tasks. She has also assisted with the on-boarding of new Attorney hires, training them on how to comply with Progressive’s security policies, how to use both the local and virtual desktops, and how to be more efficient. Her IT expertise has been tremendously valuable not only to her peers,but to the entire GA HC mgmt team arnd state by poviding training regarding the various IT issues we run into. We call her training sessions Teila’s Tech Tip Tuesdays. I really enjoy working with Teila.  She has brought so much to the GA HC team. Please let me know if you need any additional information.",
  },
  {
    Name: "Harvey Beress - Attorney Manager",
    Comment:
      "I think you would be great in a technology role, or in a variety of fields outside of legal. You are one of the top Legal Assistants in one of Progressive’s largest and highest volume house counsel offices in the country.You thrive in an environment that requires you to multi-task, to work quickly and to be very accurate. You go above and beyond on a regular basis, not just by assisting other LAs, but also by creating your “Teila’s Tech Tip” series, and even taking your valuable time to give me a one-on-one tech training session.  Your manager has the trust and confidence in you to have you train new attorneys on the ins and outs of our case management software. You are an integral part of how we try to maintain an excellent work environment.I know that over the years, you have offered suggestions,volunteered, and come up with ideas. You are smart, hard-working and capable of doing anything you set your mind to.You would be a great asset to the Technology Department at Progressive.",
  },
  {
  ...
  },
  {
    ...
    Comment:
      "Teila is a consummate professional. She carries a giggle in her tone that comforts the student as she teaches and bears no intimidation within b/c your heart is for you both to win. You dig deeper than the surface requirement for the jewels most overlook but we’re so glad you did. So, to say that you are thorough, detail-oriented and success-driven is a minimal assessment of your values but quite the guarantee that Progressive can celebrate its selection of you because of the anticipated impact. SIS is a diamond in the rough and I expect Progressive to recognize its own jewel’s ever rising value and situate her securely because of that realization 😉 ",
  },
  {
